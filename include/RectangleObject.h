...
class RectangleObject {
	    ...
	    public:
	    RectangleObject(std::string diffusePath, std::string specularPath)
		: rectShader("resources/shaders/rectangleObjectShader.vs",
			...
			//        GL_FALSE, 8 * sizeof(float), (void*)(3 *
	    ...
	    void setup(glm::mat4 projection, glm::mat4 view, glm::vec3 viewPos,
			...
			rectShader.setVec3("dirLight.direction",
					   dirLight.direction);
			rectShader.setVec3("dirLight.ambient",
					   dirLight.ambient);
			rectShader.setVec3("dirLight.diffuse",
					   dirLight.diffuse);
			rectShader.setVec3("dirLight.specular",
					   dirLight.specular);

			// point lights
			//        rectShader.setVec3("pointLights[0].position",
			//        glm::vec3(xScaling1,yScaling1,zScaling1)*(glm::vec3(30.0f,0.0f,-30.0f)+glm::vec3(xTranslate1,yTranslate1,zTranslate1)));
			//        rectShader.setVec3("pointLights[0].ambient",
			//        0.05f, 0.05f, 0.05f);
			//        rectShader.setVec3("pointLights[0].diffuse",
			//        0.8f, 0.8f, 0.8f);
			//        rectShader.setVec3("pointLights[0].specular", 1.0f,
			//        1.0f, 1.0f);
			//        rectShader.setFloat("pointLights[0].constant", 1.0f);
			//        rectShader.setFloat("pointLights[0].linear",
			//        0.009);
			//        rectShader.setFloat("pointLights[0].quadratic",
			//        0.0032);

			for ( int i = 0; i < pointLights.size(); ++i ) {
				    std::string iStr = std::to_string(i);
				    rectShader.setVec3("pointLights[" + iStr +
							   "].position",
				    ...
				    rectShader.setFloat("pointLights[" + iStr +
							    "].linear",
			...
			rectShader.setVec3("spotLight.position",
					   spotLight.position);
			rectShader.setVec3("spotLight.direction",
					   spotLight.direction);
			//        rectShader.setVec3("spotLight.position",viewPos);
			//        rectShader.setVec3("spotLight.direction",front);
			rectShader.setVec3("spotLight.ambient",
					   spotLight.ambient);
			rectShader.setVec3("spotLight.diffuse",
					   spotLight.diffuse);
			rectShader.setVec3("spotLight.specular",
					   spotLight.specular);
			rectShader.setFloat("spotLight.constant",
					    spotLight.constant);
			rectShader.setFloat("spotLight.linear",
					    spotLight.linear);
			rectShader.setFloat("spotLight.quadratic",
					    spotLight.quadratic);
			rectShader.setFloat("spotLight.cutOff",
					    spotLight.cutOff);
			rectShader.setFloat("spotLight.outerCutOff",
	    ...
	    //        GL_TEXTURE_2D operations now have effect on this texture
	    //        object
	    //        // set the texture wrapping parameters
	    //        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S,
	    //        GL_REPEAT);	// set texture wrapping to GL_REPEAT (default
	    //        wrapping method) glTexParameteri(GL_TEXTURE_2D,
	    ...
	    //        // The FileSystem::getPath(...) is part of the GitHub
	    //        repository so we can find files on any IDE/platform;
	    //        replace it with your own image path. unsigned char *data =
	    //        stbi_load(FileSystem::getPath(texturePath).c_str(),
	    //        &width, &height, &nrChannels, 0); if (data)
	    //        {
