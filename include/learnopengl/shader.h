...
class Shader {
	    ...
	    Shader(const char *vertexPath, const char *fragmentPath,
		   const char *geometryPath = nullptr) {
			...
			try {
				    ...
				    // if geometry shader path is present, also
				    // load a geometry shader
				    if ( geometryPath != nullptr ) {
						std::string geometryPathString(
						    geometryPath);
						geometryPath =
						    geometryPathString.c_str();
				    ...
				    std::cout << "ERROR::SHADER::FILE_NOT_"
						 "SUCCESFULLY_READ"
					      << std::endl;
			}
			...
			if ( geometryPath != nullptr ) {
				    ...
				    glShaderSource(geometry, 1, &gShaderCode,
						   NULL);
	    ...
	    void setVec2(const std::string &name, float x, float y) const {
			glUniform2f(glGetUniformLocation(ID, name.c_str()), x,
				    y);
	    }
	    // ------------------------------------------------------------------------
	    ...
	    void setVec3(const std::string &name, float x, float y,
			 float z) const {
			glUniform3f(glGetUniformLocation(ID, name.c_str()), x,
				    y, z);
	    }
	    // ------------------------------------------------------------------------
	    ...
	    void setVec4(const std::string &name, float x, float y, float z,
			 float w) {
			glUniform4f(glGetUniformLocation(ID, name.c_str()), x,
				    y, z, w);
	    }
	    // ------------------------------------------------------------------------
